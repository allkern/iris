...
void iop_invalidate_cache_page(struct iop_state* iop, uint32_t addr) {
    if (!iop_is_executable_region(addr))
        return;
...
static inline void iop_i_lb(struct iop_state* iop, iop_instruction& ins) {
    iop->r[T] = SE8(iop_bus_read8(iop, iop->r[S] + IMM16S));
}

static inline void iop_i_lh(struct iop_state* iop, iop_instruction& ins) {
    iop->r[T] = SE16(iop_bus_read16(iop, iop->r[S] + IMM16S));
}
...
static inline void iop_i_lwl(struct iop_state* iop, iop_instruction& ins) {
	...
	const uint32_t load = iop_bus_read32(iop, addr & 0xfffffffc);
...
static inline void iop_i_sb(struct iop_state* iop, iop_instruction& ins) {
    ...
    iop_bus_write8(iop, iop->r[S] + IMM16S, iop->r[T]);
}
...
static inline void iop_i_sh(struct iop_state* iop, iop_instruction& ins) {
    ...
    iop_bus_write16(iop, iop->r[S] + IMM16S, iop->r[T]);
}
...
static inline void iop_i_swl(struct iop_state* iop, iop_instruction& ins) {
    ...
    iop_bus_write32(iop, addr & 0xfffffffc, value);
}
    ...
    switch ((opcode & 0xfc000000) >> 26) {
        case 0x00000000 >> 26: {
            switch (opcode & 0x0000003f) {
                case 0x00000000: i.dst = i.rd; i.src1 = i.rt; i.id = IOP_I_SLL; i.func = iop_i_sll; return i;
                case 0x00000002: i.dst = i.rd; i.src1 = i.rt; i.id = IOP_I_SRL; i.func = iop_i_srl; return i;
                case 0x00000003: i.dst = i.rd; i.src1 = i.rt; i.id = IOP_I_SRA; i.func = iop_i_sra; return i;
                case 0x00000004: i.dst = i.rd; i.src1 = i.rt; i.src2 = i.rs; i.id = IOP_I_SLLV; i.func = iop_i_sllv; return i;
                case 0x00000006: i.dst = i.rd; i.src1 = i.rt; i.src2 = i.rs; i.id = IOP_I_SRLV; i.func = iop_i_srlv; return i;
                case 0x00000007: i.dst = i.rd; i.src1 = i.rt; i.src2 = i.rs; i.id = IOP_I_SRAV; i.func = iop_i_srav; return i;
                ...
                case 0x00000010: i.dst = i.rd; i.id = IOP_I_MFHI; i.func = iop_i_mfhi; return i;
                ...
                case 0x00000023: i.dst = i.rd; i.src1 = i.rs; i.src2 = i.rt; i.id = IOP_I_SUBU; i.func = iop_i_subu; return i;
                case 0x00000024: i.dst = i.rd; i.src1 = i.rs; i.src2 = i.rt; i.id = IOP_I_AND; i.func = iop_i_and; return i;
        ...
        case 0x04000000 >> 26: {
            switch ((opcode & 0x001f0000) >> 16) {
                case 0x00000000 >> 16: i.src1 = i.rs; i.branch = 1; i.id = IOP_I_BLTZ; i.func = iop_i_bltz; return i;
                case 0x00010000 >> 16: i.src1 = i.rs; i.branch = 1; i.id = IOP_I_BGEZ; i.func = iop_i_bgez; return i;
                case 0x00100000 >> 16: i.src1 = i.rs; i.branch = 1; i.id = IOP_I_BLTZAL; i.func = iop_i_bltzal; return i;
                case 0x00110000 >> 16: i.src1 = i.rs; i.branch = 1; i.id = IOP_I_BGEZAL; i.func = iop_i_bgezal; return i;
                // bltz/bgez dupes
                default: {
                    i.src1 = i.rs;
                    i.branch = 1;
                    ...
                    if (opcode & 0x00010000) {
                        i.id = IOP_I_BGEZ; i.func = iop_i_bgez;
                    } else {
                        i.id = IOP_I_BLTZ; i.func = iop_i_bltz;
                    }
        ...
        case 0x10000000 >> 26: i.src1 = i.rt; i.src2 = i.rs; i.branch = 1; i.id = IOP_I_BEQ; i.func = iop_i_beq; return i;
        case 0x14000000 >> 26: i.src1 = i.rt; i.src2 = i.rs; i.branch = 1; i.id = IOP_I_BNE; i.func = iop_i_bne; return i;
        case 0x18000000 >> 26: i.src1 = i.rs; i.branch = 1; i.id = IOP_I_BLEZ; i.func = iop_i_blez; return i;
        case 0x1c000000 >> 26: i.src1 = i.rs; i.branch = 1; i.id = IOP_I_BGTZ; i.func = iop_i_bgtz; return i;
        case 0x20000000 >> 26: i.dst = i.rt; i.src1 = i.rs; i.id = IOP_I_ADDI; i.func = iop_i_addi; return i;
        case 0x24000000 >> 26: i.dst = i.rt; i.src1 = i.rs; i.id = IOP_I_ADDIU; i.func = iop_i_addiu; return i;
        case 0x28000000 >> 26: i.dst = i.rt; i.src1 = i.rs; i.id = IOP_I_SLTI; i.func = iop_i_slti; return i;
        case 0x2c000000 >> 26: i.dst = i.rt; i.src1 = i.rs; i.id = IOP_I_SLTIU; i.func = iop_i_sltiu; return i;
        case 0x30000000 >> 26: i.dst = i.rt; i.src1 = i.rs; i.id = IOP_I_ANDI; i.func = iop_i_andi; return i;
        case 0x34000000 >> 26: i.dst = i.rt; i.src1 = i.rs; i.id = IOP_I_ORI; i.func = iop_i_ori; return i;
        case 0x38000000 >> 26: i.dst = i.rt; i.src1 = i.rs; i.id = IOP_I_XORI; i.func = iop_i_xori; return i;
        case 0x3c000000 >> 26: i.dst = i.rt; i.id = IOP_I_LUI; i.func = iop_i_lui; return i;
        case 0x40000000 >> 26: {
            switch ((opcode & 0x03e00000) >> 21) {
                case 0x00000000 >> 21: i.dst = i.rt; i.id = IOP_I_MFC0; i.func = iop_i_mfc0; return i;
                case 0x00800000 >> 21: i.src1 = i.rt; i.id = IOP_I_MTC0; i.func = iop_i_mtc0; return i;
...
#define IOP(m) ujit::mem_ptr(iop->iop_ptr, offsetof(iop_state, m))

static inline void iop_flush_reg_cache(struct iop_state* iop, asmjit::ujit::UniCompiler* uc) {
    ...
    for (int i = 1; i < 32; i++) {
        if (iop->reg_cache[i].valid && iop->reg_cache[i].dirty) {
            ...
            uc->store_u32(ujit::mem_ptr(iop->iop_ptr, offsetof(iop_state, r) + i * sizeof(uint32_t)), reg);
        }
...
static inline iop_cached_reg& iop_alloc_load_reg(struct iop_state* iop, asmjit::ujit::UniCompiler* uc, int reg) {
    using namespace asmjit;
...
static inline iop_cached_reg& iop_alloc_store_reg(struct iop_state* iop, asmjit::ujit::UniCompiler* uc, int reg) {
    using namespace asmjit;

    if (reg == 0) {
        printf("Warning: Attempting to allocate register 0 for writing. This is a no-op.\n");
...
static inline iop_cached_reg& iop_alloc_const_reg(struct iop_state* iop, asmjit::ujit::UniCompiler* uc, int reg, uint32_t value) {
    using namespace asmjit;
...
static inline void iop_sextn(asmjit::ujit::UniCompiler& uc, const asmjit::ujit::Gp& reg, uint32_t bits) {
...
static inline asmjit::ujit::Gp iop_mul_load_operand(asmjit::ujit::UniCompiler& uc, const iop_cached_reg& c, bool is_signed) {
...
static inline asmjit::ujit::Gp iop_value_to_gp32(asmjit::ujit::UniCompiler& uc, const iop_cached_reg& c) {
    if (!c.constant)
        return c.reg;
...
void iop_compile_block(struct iop_state* iop, iop_block* block) {
    using namespace asmjit;

    CodeHolder code;

    code.init(iop->rt.environment(), iop->rt.cpu_features());
    // code.set_logger(iop->logger);

    ujit::BackendCompiler bc(&code);
    ujit::UniCompiler uc(&bc, iop->rt.cpu_features(), iop->rt.cpu_hints());

    FuncNode* func = uc.add_func(FuncSignature::build<void, iop_state*>());

    iop->iop_ptr = uc.new_gp_ptr();

    func->set_arg(0, iop->iop_ptr);
    ...
    // printf("\nCompiling block at 0x%08x with %zu instructions\n", block->start_pc, block->instructions.size());
    ...
    for (int i = 0; i < iop->instruction_buf_index; i++) {
        ...
        switch (ins.id) {
            ...
            case IOP_I_LHU:
            case IOP_I_LW: {
                uint32_t (*func)(struct iop_state*, uint32_t) = nullptr;

                switch (ins.id) {
                    case IOP_I_LB:
                    case IOP_I_LBU: func = iop_bus_read8; break;
                    case IOP_I_LH:
                    case IOP_I_LHU: func = iop_bus_read16; break;
                    case IOP_I_LW: func = iop_bus_read32; break;
                }

                // If RS and RT are the same, iop_alloc_store_reg will change the constant bool
                // to indicate that the register is no longer constant. We assign the result
                // of iop_alloc_load_reg by value to preserve the constant bool and the
                ...
                iop_cached_reg& t = iop_alloc_store_reg(iop, &uc, T);

                if (s.constant) {
                    jit_function_call(&uc, func, t.reg, iop->iop_ptr, Imm(s.value + ins.imm16s));
                } else {
                    ujit::Gp addr = uc.new_gp32();

                    uc.add(addr, s.reg, Imm(ins.imm16s));

                    jit_function_call(&uc, func, t.reg, iop->iop_ptr, addr);
                }
            ...
            case IOP_I_LUI: {
                ...
                iop_alloc_const_reg(iop, &uc, T, ins.imm16 << 16);
            } break;
            ...
            case IOP_I_XORI: {
                ...
                if (s.constant) {
                    ...
                    iop_alloc_const_reg(iop, &uc, T, result);
                } else {
                    iop_cached_reg& t = iop_alloc_store_reg(iop, &uc, T);
            ...
            case IOP_I_J: {
                ...
                int module = iop_get_module_for_address(iop, block->end_pc - 4, &slot);
                ...
                switch (module) {
                    case MODULE_IOMAN: {
                        jit_function_call(&uc, iop_delegate_ioman, tmp, iop->iop_ptr, Imm(slot), Imm(0));
                    } break;

                    case MODULE_IOMANX: {
                        jit_function_call(&uc, iop_delegate_ioman, tmp, iop->iop_ptr, Imm(slot), Imm(1));
                    } break;

                    case MODULE_LOADCORE: {
                        jit_function_call(&uc, iop_delegate_loadcore, tmp, iop->iop_ptr, Imm(slot));
                    } break;

                    case MODULE_SYSMEM: {
                        jit_function_call(&uc, iop_delegate_sysmem, tmp, iop->iop_ptr, Imm(slot));
                    } break;
                }
            ...
            case IOP_I_JAL: {
                iop_alloc_const_reg(iop, &uc, 31, block->end_pc);
            ...
            case IOP_I_JALR: {
                ...
                if (s.constant) {
                    if (D) iop_alloc_const_reg(iop, &uc, D, block->end_pc);
            ...
            case IOP_I_SYSCALL: {
                jit_function_call(&uc, iop_exception, iop->iop_ptr, Imm(ins.id == IOP_I_SYSCALL ? CAUSE_SYSCALL : CAUSE_BP));
            } break;
            ...
            case IOP_I_MULTU: {
                ...
                if (s.constant && t.constant) {
                    ...
                    ujit::Gp a = iop_mul_load_operand(uc, s, is_signed);
                    ujit::Gp b = iop_mul_load_operand(uc, t, is_signed);
            ...
            default: {
                ...
                jit_function_call(&uc, ins.func, iop->iop_ptr, Imm((uintptr_t)&ins));
...
iop_block* iop_find_block(struct iop_state* iop, uint32_t pc) {
    ...
    iop_block* block = &iop->block_cache[page].blocks[offset];
