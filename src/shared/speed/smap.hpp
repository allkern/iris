...
typedef void (*tx_fn)(void* udata, const uint8_t* buf, int len);

struct Smap {
    Bd tx_bd[SMAP_BD_MAX_ENTRY];
    Bd rx_bd[SMAP_BD_MAX_ENTRY];
    ...
    uint32_t emac3_mode1;
    uint32_t emac3_txmode0;
    uint32_t emac3_txmode1;
    uint32_t emac3_rxmode;
    uint32_t emac3_intr_stat;
    uint32_t emac3_intr_enable;
    uint32_t emac3_addr_hi;
    uint32_t emac3_addr_lo;
    uint32_t emac3_vlan_tpid;
    uint32_t emac3_vlan_tci;
    uint32_t emac3_pause_timer;
    uint32_t emac3_individ_hash1;
    uint32_t emac3_individ_hash2;
    uint32_t emac3_individ_hash3;
    uint32_t emac3_individ_hash4;
    uint32_t emac3_group_hash1;
    uint32_t emac3_group_hash2;
    uint32_t emac3_group_hash3;
    uint32_t emac3_group_hash4;
    uint32_t emac3_last_sa_hi;
    uint32_t emac3_last_sa_lo;
    uint32_t emac3_inter_frame_gap;
    uint32_t emac3_sta_ctrl;
    uint32_t emac3_tx_threshold;
    uint32_t emac3_rx_watermark;
    uint32_t emac3_tx_octets;
    uint32_t emac3_rx_octets;
    ...
    uint8_t rx_frame_cnt;
    uint32_t tx_bd_index;
