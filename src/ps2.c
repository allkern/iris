...
void ps2_init(struct ps2_state* ps2) {
    ...
    ps2_iop_dma_init(ps2->iop_dma, ps2->iop_intc, ps2->sif, ps2->cdvd, ps2->ee_dma, ps2->sio2, ps2->sched, ps2->iop_bus);
    ...
    ps2_spu2_init(ps2->spu2, ps2->iop_intc, ps2->sched);
