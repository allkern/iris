...
#define GS_EE_CLOCK 294912000
#define GS_EE_CLOCKS_PER_FRAME_NTSC (GS_EE_CLOCK / 60)
#define GS_EE_CLOCKS_PER_SCAN_NTSC (GS_EE_CLOCKS_PER_FRAME_NTSC / 262)
#define GS_EE_CLOCKS_PER_VFRAME (GS_EE_CLOCKS_PER_SCAN_NTSC * 240)
#define GS_EE_CLOCKS_PER_VBLANK (GS_EE_CLOCKS_PER_SCAN_NTSC * 22)
#define GS_FRAME_NTSC 4502400 // (240 * 9370)
#define GS_VBLANK_NTSC 412720 // (22 * 9370)
